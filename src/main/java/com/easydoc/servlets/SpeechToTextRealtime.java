...
public class SpeechToTextRealtime {
  ...
  public static String convertMillisToDate(double milliSeconds) {
    ...
    return String.format("%s:%s /", format.format(TimeUnit.MILLISECONDS.toMinutes(millis)), format.format(
  ...
  public static void infiniteStreamingRecognize(String languageCode) throws Exception {
    ...
    try (SpeechClient client = SpeechClient.create()) {
      ...
      RecognitionConfig recognitionConfig = RecognitionConfig.newBuilder()
          .setEncoding(RecognitionConfig.AudioEncoding.LINEAR16).setLanguageCode(languageCode).setSampleRateHertz(16000)
          .build();
 ...
 */
class InfiniteStreamRecognizeOptions {
  ...
  public static InfiniteStreamRecognizeOptions fromFlags(String[] args) {
    ...
    options.addOption(Option.builder().type(String.class).longOpt("lang_code").hasArg().desc("Language code").build());
